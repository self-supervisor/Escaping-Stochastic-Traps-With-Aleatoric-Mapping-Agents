...
environment=MiniGrid-MultiRoom-N6-v0 #MiniGrid-KeyCorridorS6R3-v0 #MiniGrid-MultiRoom-N4-S5-v0 #, #MiniGrid-FourRooms-v0
...
for frames_before_reset in ${frames_before_resets[@]}; do
    ...
    random_action=False
    reward_weighting=100
    noisy_tv=(True False)
    curiosity=(True)
    uncertainty=(True)
    save_interval=2000
    normalise_rewards=True #False #True
    icm_lr=0.01
    visualizing=False
